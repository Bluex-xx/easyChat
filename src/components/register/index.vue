<template>
  <div class="login_content">
    ...
    <div class="login_box">
      <div class="login_box_title">账号注册</div>
      <div class="input_box">
        <input
          placeholder="account"
          type="text"
        ...
        <input
          ...
          type="password"
          v-model="user_info.repeatPassword"
          id="password"
        />
      </div>
      <div class="select_box">
        ...
        <RouterLink to="/"
          ><div class="login_box_register">Login</div></RouterLink
        >
      </div>
      <div @click="loginPost(user_info)" class="login_btn">注册</div>
    </div>
    <div class="copyright">
